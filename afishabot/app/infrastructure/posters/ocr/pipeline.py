...
from app.infrastructure.posters.ocr.backends.factory import build_default_ocr_backends
from app.infrastructure.posters.ocr.backends.null_backend import NullOCRBackend
from app.infrastructure.posters.ocr.cache.file_raw_cache import FileRawOCRCacheStore
from app.infrastructure.posters.ocr.cache.fingerprints import SimpleFingerprintService
from app.infrastructure.posters.ocr.cache.null_result_store import NullPosterOCRResultStore
from app.infrastructure.posters.ocr.config import PosterOCRConfig, build_poster_ocr_config
from app.infrastructure.posters.ocr.fusion.backend_result_utils import (
    build_confidence,
    build_raw_text,
    is_backend_result_successful,
)
from app.infrastructure.posters.ocr.fusion.block_fuser import fuse_blocks
from app.infrastructure.posters.ocr.fusion.result_persistence import should_persist_result
...
from app.infrastructure.posters.ocr.protocols import (
    FingerprintService,
    OCRBackend,
    PosterOCRResultStore,
    RawOCRCacheStore,
)
from app.infrastructure.posters.ocr.result.normalized_text_builder import (
