...
from app.infrastructure.posters.ocr.entities.line_classifier import (
    classify_normalized_block_text,
    resolve_normalized_block_text,
)
from app.infrastructure.posters.ocr.layout.word_merge import merge_block_lines
from app.infrastructure.posters.ocr.normalize.line_normalizer import normalize_merged_line
from app.infrastructure.posters.ocr.result.runtime_dictionary_builder import (
    build_runtime_dictionary,
)
from app.infrastructure.posters.ocr.models import OCRBlock, PosterOCRContext
